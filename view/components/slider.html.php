...
<div class="block block-lead slider" data-component="slider">
    <input id="slider-0-0" class="hidden slide" name="x-slider" type="radio" checked=""/>
    <input id="slider-0-1" class="hidden slide" name="x-slider" type="radio"/>
    <input id="slider-0-2" class="hidden slide" name="x-slider" type="radio"/>
    ...
    <ul class="inline-container view module">
        <li class="inline-container view item">
            <div class="inline">
                <h3 class="title">Říjnová Rollo akce</h3>
                <figure class="inline-container container">
                    <img class="inline image" src="img/fornetti-minit-offer-croissant-poppy-seed.jpg" srcset="img/fornetti-minit-offer-croissant-poppy-seed.jpg 1x, img/hd/fornetti-minit-offer-croissant-poppy-seed.jpg 2x, img/hq/fornetti-minit-offer-croissant-poppy-seed.jpg 3x" alt="Říjnová Rollo akce" width="476" height="460" />
                    <figcaption class="inline xs-6 text">
                        <p>Připravili jsme pro skvělou akci. Tři maková a dvě skořicová Rolla pořídíte v průběhu října za dvacetikorunu! Novinku v našem portfoliu výrobků tak můžete ochutnat za výhodnou cenu.</p>
                        <strong class="last">Akce probíhá na vybraných pobočkách</strong>
                    </figcaption>
                </figure>
            </div>
        </li>
        ...
        <li class="inline-container view item">
            <div class="inline">
                ...
                <figure class="inline-container container">
                    <img class="inline image" src="img/fornetti-minit-croissant-poppy-seed.png" srcset="img/fornetti-minit-croissant-poppy-seed.png 1x, img/hd/fornetti-minit-croissant-poppy-seed.png 2x" alt="Fornetti Minit Croissant Poppy Seed" width="251" height="300" />
                    <figcaption class="inline xs-6 text">
